...
<html lang="pl">
  <head>
    ...
    <style>
      ...
      .reveal .star-diagram { position: relative; width: min(16em, 88%); height: 6.5em; margin: 0.45em auto 0; font-size: 0.72em; }
      ...
      .reveal .star-switch { left: 50%; top: 42%; min-width: 5.6em; min-height: 2.45em; transform: translate(-50%, -50%); border-color: #007c91; background: #e9f8fa; }
      .reveal .star-switch small { display: block; margin-top: 0.18em; color: #006678; font-size: 0.62em; font-weight: 600; }
      .reveal .star-host-a { left: 1%; top: 0; }.reveal .star-host-b { right: 1%; top: 0; }.reveal .star-host-c { left: 50%; bottom: 0.75em; transform: translateX(-50%); }
