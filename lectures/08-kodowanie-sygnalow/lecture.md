...
- HDB, kod „2 z 5” oraz kody ilorazowe.
...
Pomiar jest poprawny, gdy rzeczywisty przebieg nie wykracza poza obszar niedozwolony przez maskę.

---

## Pożądane właściwości kodu liniowego
...
Kodowanie ilorazowe (*convolutional coding*) tworzy ciąg wyjściowy zależny od bieżących i wcześniejszych bitów wejściowych.

Stan kodera jest pamięcią wcześniejszych symboli, a dekodowanie wybiera najbardziej prawdopodobną sekwencję wejściową.

---

## Kodowanie ilorazowe: intuicja
...
## Systematyczne a niesystematyczne kodowanie ilorazowe
...
- Kody liniowe wspierają synchronizację i odporność na błędy.
- HDB, „2 z 5” i kody ilorazowe rozwiązują różne problemy transmisyjne.
