...
Każdy zapis z przyrostkiem wskazuje punkt odniesienia.

<div class="columns"><div>

- **dBc**: poziom względem mocy fali nośnej lub innego sygnału odniesienia.
- **dBi**: zysk anteny względem idealnej anteny izotropowej.
- **dBd**: zysk anteny względem półfalowego dipola.

</div><div>

- **dBm**: moc względem `1 mW`.
- **dBW**: moc względem `1 W`.
- **dBµV**: napięcie względem `1 µV`.
...
`B` oznacza najwyższą częstotliwość obecnego w sygnale pasma.
